    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return searchView.clearSearchQuery();
        case 5:
          _context.next = 7;
          return searchView.clearSearchResult();
        case 7:
          (0, _base.renderLoader)(_base.elements.searchResultsDiv);
...
_base.elements.pageBtns.addEventListener("click", function (e) {
  var btn = e.target.closest(".btn-inline ");
  if (btn) {
    var goto = parseInt(btn.dataset.goto);
